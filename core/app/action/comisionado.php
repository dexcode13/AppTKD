            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <br>
                  Estimado Gerente,
                  Le informamos que el usuario de su departamento ha registrado a una 
                  Solicitud. Para realizar un seguimiento de dicha solicitud, haga clic 
                  en el botón "AppVia" a continuación para iniciar su sesion en el sistema.<br>
                  <br>
                      ...
                      <td style="width:100px;background:#D84A38;">
                        <div>
                          ...
                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:33px;v-text-anchor:middle;width:100px;" stroke="f" fillcolor="#D84A38">
                            ...
                            <center>
                          <![endif]-->
                              <a href="www.consultoresdiaf.com/SISCOVIA.3.0"
                        style="background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:100px;-webkit-text-size-adjust:none;">AppVia</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                          <![endif]-->
