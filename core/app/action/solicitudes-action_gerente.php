				...
				$message .= "<tbody>
							...
							<tr>
								<td colspan='4' style='padding:15px;'>
									<p style='font-size:20px;'>Estimado ".UserData::getById($_SESSION["user_id"])->gerente.",</p>
									<hr />
									<p style='font-size:20px;'>Te informamos que se ha registrado un nueva solicitud con las siguientes caracteristicas:</p>
								</td>
							</tr>
							<tr height='80'>
