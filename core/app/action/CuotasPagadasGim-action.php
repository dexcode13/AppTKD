...
$corte = AsistenciasData::getByMesPagadasGim($_POST["sd"]);
$mes = $_POST["sd"];
...
$printer->text("***Gimnasia***\n");
$printer->text("***Cuotas Pagadas de ".$msj."***\n");
$printer->text("\n");
...
foreach ($corte as $print) {
	...
	$printer->text($print->rgi."-->"."$print->n1"." "."$print->apellido"."\n");
...
*/
$printer->text("-------------\n");
$printer->text("Total de Alumnos: ". $alumnos ."\n");
...
*/
$printer->close();
Core::alert("Impresion de Pagos Pagados Satisfactorio");
Core::redir("./index.php?view=RptPagadas");
	
}else{

	Core::alert("No hay Pagos Pagados");
	print "<script>window.location='index.php?view=RptPagadas';</script>";
}
?>