...
$corte = AlumnosData::getCortePrintGim();
...
$printer->text("***Corte de Caja Gimnasia***\n");
...
foreach ($corte as $print) {
	...
	$printer->text($print->concepto." $cuota"." $ $print->diferencia"."\n");
	//$printer->text(."\n");
	//$printer->text(."\n");
...
Core::redir("./index.php?view=CortePagosGim");
	
}else{

	Core::alert("No hay registros de pagos en este día");
	print "<script>window.location='index.php?view=CortePagosGim';</script>";
}
?>