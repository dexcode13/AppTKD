            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <br>
                  Estimado Usuario,
                  Le informamos que su solicitud ha cambiado de estado de Vo.Bo. Para realizar un seguimiento 
                  de su solicitud o realizar cambios, haga clic en el botón "Mi Solicitud" a continuación para
                      ...
                      <td style="width:100px;background:#D84A38;">
                        <div>
                          ...
                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:33px;v-text-anchor:middle;width:100px;" stroke="f" fillcolor="#D84A38">
                            ...
                            <center>
                          <![endif]-->
                              <a href="www.consultoresdiaf.com/SISCOVIA.2.0"
                        style="background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:100px;-webkit-text-size-adjust:none;">Mi Solicitud</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                          <![endif]-->
