<div class="row">
	...
	<h1><i class='fa fa-dollar'></i> Reporte de Mensualidades por Año <strong>GIM <?php if(isset($_GET["sd"])){echo $_GET["sd"];} ;?></strong></h1>
			<form>
					<input type="hidden" name="view" value="RptCuotasxCicloGIM">
					<div class="row">
						<div class="col-md-3">
...
<div class="row">
	<div class="col-md-12">
		...
		<?php if($_GET["sd"]!=""):?>
			...
			$operations = AsistenciasData::getByCuotasCicloGIM($_GET["sd"]);
