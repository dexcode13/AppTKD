            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <h2>Su solicitud ha sufrido un cambio de estado</h2><br>
                  <br>
                  Estimado Usuario,<br>
                  Le informamos que su solicitud ha cambiado de estado de autorizacion. 
                  Para realizar un seguimiento de su solicitud o realizar cambios, haga 
                  clic en el boton "AppViatic's" a continuacion para
