<div class="row">
	...
	<h1><i class='fa fa-bar-chart'></i> Reporte de Asistencias TKD</h1>
			<form>
					<input type="hidden" name="view" value="ReporteAsistenciaTKD">
					<div class="row">
						<div class="col-md-3">
...
<div class="row">
	<div class="col-md-12">
		...
		<?php if($_GET["sd"]!="" && $_GET["ed"]!=""):?>
			<?php 
			$operations = array();
			$operations = AsistenciasData::getByBetaTKD($_GET["sd"],$_GET["ed"]);
			?>
