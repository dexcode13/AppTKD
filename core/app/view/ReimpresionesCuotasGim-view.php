<?php
$request = AlumnosData::getReimpresionesGim();
if(count($request)>0){
?>
	<div class="callout callout-info">
	<h2><i class='fa fa-file-text'></i> Reimpresión de Recibos de Cuotas Gimnasia</h2>
	</div>
...
<div class="box-body">
      ...
      <th>Fecha Pago</th>
        ...
        <td><?php echo $request1->cuota; ?></td>
				...
				<td>
				<a href='./?action=ReimprimirTicketGim&id=<?php echo $request1->id_cuota;?>'><button type="button" class="btn btn-social-icon btn-success"><i class=" fa fa-print"></i></button></a>
				</td>
				</tr>
				<?php
			}
