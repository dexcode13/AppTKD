...
if(count($_POST)>0){
	...
	$user->vobo = $_POST["vobo"];
	$user->updateSolicVobo();
...
sendmail($user->mail_jefe,$user->jefe,'ihernandez@mejorafinanzas.com.mx','Departamento de Sistemas','rdimas@mejorafinanzas.com.mx','Ing. Ruben Dario Dimas Julio',$user->email,$user->name.' '.$user->lastname,'Solicitud con VoBo Autorizado','core/app/view/notifica.php');
