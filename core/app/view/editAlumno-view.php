<?php $user = AlumnosData::getByAlumno($_GET["id"]);?>
<?php $Asistencia = AsistenciasData::getByAlumAsistencia($_GET["id"]);?>
<?php $Plan = AlumnosData::getByAlumnoPlan($_GET["id"]);?>
...
<div class="row">
  ...
  <div class="box box-primary">
      ...
      <h2 class="title"><i class="fa fa-book" aria-hidden="true"></i> Expediente de <span class="label label-success label-as-badge"><?php echo $user->nombre." ".$user->apellido;?></span></h2>
      <!-- /.nav-tabs-custom -->
      <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#personales"><i class="fa fa-user" aria-hidden="true"></i> Datos Personales</a></li>
        <li><a data-toggle="tab" href="#padres"><i class="fa fa-users" aria-hidden="true"></i> Datos Padres</a></li>
        <li><a data-toggle="tab" href="#examenes"><i class="fa fa-file" aria-hidden="true"></i> Exámenes</a></li>
        <li><a data-toggle="tab" href="#asistencias"><i class="fa fa-calendar" aria-hidden="true"></i> Asistencias</a></li>
        <li><a data-toggle="tab" href="#pagos"><i class="fa fa-calendar" aria-hidden="true"></i> Plan de Pagos</a></li>
        <li><a data-toggle="tab" href="#baja"><i class="fa fa-tags" aria-hidden="true"></i> Estatus Alumno</a></li>
      </ul>
      </div>
    <!-- /.nav-tabs-custom -->
      <div class="tab-content">
  <div id="personales" class="tab-pane fade in active"><br>
    <form class="form-horizontal" method="post" action="index.php?view=updateAlumPer" role="form" enctype="multipart/form-data">
...
<option value="<?php echo $user->id_categoria; ?>" selected><?php echo $user->categoria; ?></option>
 <?php foreach(AlumnosData::getAllCategorias() as $p):?>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="grado" value="<?php echo $user->grado_cinta;?>" class="form-control">
    </div>
  </div>
  <div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="correo" value="<?php echo $user->correo;?>" class="form-control" required id="username">
    </div>
  </div>
  <div class="form-group">
...
<div class="checkbox">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="user_id" value="<?php echo $user->rgi;?>">
      <button type="submit" class="btn btn-success">Aplicar Baja Temporal</button>
    </div>
  </div>
  </div><!--fin datos izquierda-->
  <!--<div class=" col-md-6 col-lg-6">
