...
<div class="box-body">
      ...
      <th>Pago</th>
        ...
        if ($p->id_tipo==1 and $p->id_perfil==2 and $request1->id_departamento==3){
          ?><a href='./?view=opensolicAdmin&id=<?php echo $request1->id_solicitud;?>'><i class="fa fa-eye fa-fw"></i><?php echo $request1->id_solicitud; ?></a><?php
        }else
        {
          ?><a href='./?view=opensolicitud&id=<?php echo $request1->id_solicitud;?>'><i class="fa fa-eye fa-fw"></i><?php echo $request1->id_solicitud; ?></a><?php
        }
        ?>
        </td>
...
<div class="table-responsive">
     ...
     <td style="width:100px;"><center>
		...
		//Si es usuario y juridico
      		...
      		$request = SolicitudData::getJuridico();
		if(count($request)>0){
			?>
<div class="box box-primary">
<div class="box-body">
