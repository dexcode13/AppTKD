<div class="row">
	...
	<div class="callout callout-info">
	<h2><i class='fa fa-tags'></i> Cobros de Mensualidades</h2>
	</div>
		<?php
	  $request = AlumnosData::getPagosPendientes();
...
<form class="form-horizontal" role="form" method="post" action="./?action=pagarCuota">
