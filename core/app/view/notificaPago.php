            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <h2>Su Solicitud ha sido PAGADA</h2><br>
                  <br>
                  Estimado Usuario,<br>
                  Le informamos que el area de Tesoreria a realizado el pago de su Solicitud
                  registrada. Para imprimir el recibo de dicha solicitud, 
                  haga clic en el boton "AppViatic's" a continuacion para
                  iniciar su sesion en el sistema y despues sobre el icono de la impresora<br>
