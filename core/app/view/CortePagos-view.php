...
<div class="row">
  ...
  <div class="callout callout-info">
	<h2><i class='fa fa-print'></i> Impresión de Corte del día</h2>
	</div>
      <div class="alert alert-warning">
        <strong>¡Advertencia!</strong> Solo podrá imprimir los pagos realizados <strong>DEL PRESENTE DIA</strong>
      </div>
     
		<form class="form-horizontal" method="post" id="addproduct" action="index.php?action=ImpresionCorteECHO" role="form">
  <div class="form-group">
    <div class="col-lg-2 col-lg-10">
      <button type="submit" class="btn btn-success btn-lg">Imprimir Corte del dia</button>
    </div>
  </div>
</form>
<?php 
$request = AlumnosData::getCortePrint();
?>
...
<div class="box-body">
      ...
      <th>Cuota</th>
        ...
        <td>$ 
        <?php if ($request1->cobro=="GIM") {
          if ($request1->importe>300) {
            echo "125.00";           
          } else {
