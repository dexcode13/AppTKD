...
<div class="box-body">
     ...
     <td style="width:100px;"><center><?php  
		if($request1->vobo) { echo "<p class='label label-success'><i class='glyphicon glyphicon-ok'></i> Autorizada</p>"; }
     ...
     <td style="width:100px;"><center><?php  
		...
		{ echo "<p class='label label-success'><i class='glyphicon glyphicon-ok'></i> Autorizada</p>"; }
		else if ($request1->id_status==2)
		{echo "<p class='label label-danger'><i class='glyphicon glyphicon-remove'></i> Cancelada</p>"; }
		else
		{echo "<p class='label label-primary'><i class='glyphicon glyphicon-ok'></i> Pagada</p>"; }
		 ?>
		 </center></td>
     <td style="width:100px;"><center><?php  
		if($request1->pagada) { echo "<p class='label label-success'><i class='glyphicon glyphicon-ok'></i> Pagada</p>"; }
		else { echo "<p class='label label-warning'><i class='glyphicon glyphicon-time'></i> Pendiente</p>"; }
		 ?>
		 </center></td>
		 <td>
		 <button type="button" class="btn btn-social-icon btn-remove" title="Imprimir" id="view" onclick="window.open('/SISCOVIA.3.0/core/app/view/formato-solicitud.php?&id=<?php echo $request1->id_solicitud; ?>','_blank')"><i class=" fa fa-print"></i></button>
		 </td>
				</tr>
				<?php
...
<div class="table-responsive">
      ...
      <th>Pago</th>
        ...
        <td><?php echo $request1->fecha_retorno; ?></td>
     <td style="width:100px;"><center><?php  
		if($request1->id_status) { echo "<p class='label label-success'><i class='glyphicon glyphicon-ok'></i> Autorizada</p>"; }
		else { echo "<p class='label label-warning'><i class='glyphicon glyphicon-time'></i> Pendiente</p>"; }
		 ?>
		 </center></td>
     <td style="width:100px;"><center><?php  
     ...
     <td style="width:100px;"><center><?php  
		...
		echo $request1->fecha_pago;
		 ...
		 if($request1->vobo==1 && $request1->pagada==1 && $request1->id_status==1)
		 {
				...
				?>
				<button type="button" class="btn btn-social-icon btn-success" title="Imprimir" id="view" onclick="window.open('/SISCOVIA.3.0/core/app/view/formato-solicitud.php?&id=<?php echo $request1->id_solicitud; ?>','_blank')"><i class=" fa fa-print"></i></button>
		 <?php
		 }
		 else
		 {
