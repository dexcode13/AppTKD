...
$comprob= ComprobantesData::getAllBySolicVales($solic->id_solicitud);
...
<form class="form-horizontal" role="form" method="post" action="./?action=addcomprobVales" enctype="multipart/form-data">
...
<br><br>
                <p class="message">
                    <a href="#" class="name">
                      <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> <?php echo $comprobante->fecha_comprob;?></small>
                      
                    </a>
                    <?php echo $comprobante->descripcion; ?>
                    <?php if($comprobante->vauche!=""):?>
                    <div class="attachment">
                      <p class="filename">
                        <a href='./storage/comprobantes/<?php echo $comprobante->id_solicitud; ?>/<?php echo $comprobante->vauche; ?>' target="_blank"><i class='fa fa-file-o'></i> <?php echo $comprobante->vauche;?></a>
                      </p>
                    </div>
                    <?php endif; ?>
                </p>
