<div class="row">
	...
	<div class="callout callout-info">
	<h2><i class='fa fa-tags'></i> Cobros de Anualidades TKD</h2>
	</div>
		<?php
	  $request = AlumnosData::getAnualidadesPendientesTKD();
...
<form class="form-horizontal" role="form" method="post" action="./?action=pagarAnualidadTKD">
