              ...
              <tr>
                <td valign="top" class="mobile-block mobile-no-padding-bottom mobile-center" width="270" style="background:#1f1f1f;padding:10px 10px 10px 20px;">
                  <a href="#" style="text-decoration:none;">
                    <img src="http://consultoresdiaf.com/SISCOVIA.2.0/img/prueba.png" width="142" height="30" alt="Agrofinanciera DG"/>
                  </a>
                </td>
                <td valign="top" class="mobile-block mobile-center" width="270" style="background:#1f1f1f;padding:10px 15px 10px 10px">
                  <table border="0" cellpadding="0" cellspacing="0" class="mobile-center-block" align="right">
                    <tr>
                      <td align="right">
                        <a href="#">
                        <img src="http://keenthemes.com/assets/img/emailtemplate/social_facebook.png"  width="30" height="30" alt=""/>
                        </a>
                      </td>
                      <td align="right" style="padding-left:5px">
                        <a href="#">
                        <img src="http://keenthemes.com/assets/img/emailtemplate/social_twitter.png"  width="30" height="30" alt=""/>
                        </a>
                      </td>
                      <td align="right" style="padding-left:5px">
                        <a href="#">
                        <img src="http://keenthemes.com/assets/img/emailtemplate/social_googleplus.png"  width="30" height="30" alt=""/>
                        </a>
                      </td>
                      <td align="right" style="padding-left:5px">
                        <a href="#">
                        <img src="http://keenthemes.com/assets/img/emailtemplate/social_linkedin.png"  width="30" height="30" alt=""/>
                        </a>
                      </td>
                      <td align="right" style="padding-left:5px">
                        <a href="#">
                        <img src="http://keenthemes.com/assets/img/emailtemplate/social_rss.png"  width="30" height="30" alt=""/>
                        </a>
                      </td>
                    </tr>
                  </table>
            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <h2>Una Solicitud tiene el VoBo "Autorizado"</h2><br>
                  <br>
                  Estimado Gerente de Administracion y Finanzas,
                  Le informamos que un Gerente ha dado el VoBo a una Solicitud
                  registrada por un usuario a su cargo. Para realizar un seguimiento 
                  de dicha solicitud, haga clic en el boton "AppViatic's" a continuacion para
                  iniciar su sesion en el sistema.<br>
                      ...
                      <td style="width:100px;background:#D84A38;">
                        <div>
                          ...
                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:33px;v-text-anchor:middle;width:100px;" stroke="f" fillcolor="#D84A38">
                            ...
                            <center>
                          <![endif]-->
                              <a href="http://www.consultoresdiaf.com/AppViatics.3.0"
                        style="background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:100px;-webkit-text-size-adjust:none;">AppViatic's</a>
                          <!--[if mso]>
                            </center>
                          </v:rect>
                          <![endif]-->
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                      ...
                      <td style="padding-top:5px; border-top:1px solid #E7E7E7;">
                        Av. Lazaro Cardenas N 29<br>
                        Local 5, 6 y 7<br>
                        Col. Lomas de las Flores C.P. 24060
                      </td>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                          <tr>
                            <td width="350" style="vertical-align:top;">
                              Gracias por usar este servicio. Por favor  <a href="www.mejorafinanzas.com.mx">contactenos</a> para cualquier problema del sistema.<br>
                              <h4>AppViatic's v3.0<h4>
                            </td>
                          </tr>
                        </table>
                      </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="height:100%;color:#ffffff" bgcolor="#1f1f1f" >
              <tr>
                <td align="right" valign="middle" class="mobile-padding" style="font-size:12px;padding:20px; background-color:#1f1f1f; color:#ffffff; text-align:left; ">
                  ...
                  <a style="color:#ffffff;" href="www.mejora">Soporte</a>
                </td>
              </tr>
            </table>
          </center>
