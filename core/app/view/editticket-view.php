...
<div class="row">
	<div class="col-md-8">
      ...
      <h2 class="title">Modificar Ticket</h2>
<a href="./?view=openticket&id=<?php echo $reservation->id; ?>" class="btn btn-default">Ver ticket</a>
...
<option value="">-- SELECCIONE --</option>
  <?php foreach(PersonData::getAll() as $p):?>
    <option value="<?php echo $p->id; ?>" <?php if($p->id==$reservation->person_id){ echo "selected"; }?>><?php echo $p->name." ".$p->lastname; ?></option>
  <?php endforeach; ?>
</select>
    </div>
    ...
    <div class="col-lg-10">
<select name="asigned_id" class="form-control" required>
<option value="">-- SELECCIONE --</option>
  <?php foreach(UserData::getAll() as $p):?>
    <option value="<?php echo $p->id; ?>" <?php if($p->id==$reservation->asigned_id){ echo "selected"; }?>><?php echo $p->name." ".$p->lastname; ?></option>
  <?php endforeach; ?>
</select>
    </div>
