...
*/
		...
		$mes = strftime("%B");
		$mes_actual = strtoupper($mes);
if(isset($_GET["op"]) && $_GET["op"]=="all"):?>
<section class="">
<div class="row">
	<div class="col-md-12">
		<h1>Cobro de Mensualidades</h1>
...
<div class="box-body">
      ...
      <th>Pago</th>
        ...
        <td>
				<?php
				if($request1->pago=="pagado")
				{
					echo $request1->rgi;;
				}
				else{
					?>
					<a href='./?view=openAlumno&rgi=<?php echo $request1->rgi;?>'><?php echo $request1->rgi; ?></a>
				<?php
				}
          ?>
        </td>
        <td><?php echo $request1->alumno; ?></td>
				<td><?php echo $request1->mes; ?></td>
				<td>$ <?php echo $request1->monto; ?></td>
				<td><?php echo $request1->fecha_pago; ?></td>
				<td>
				<?php  
				if($request1->pago=='pagado') { echo "<p class='label label-success'><i class='glyphicon glyphicon-ok'></i> Pagado</p><br>";
				 }
