...
<option value="">Usuario</option>
  <?php foreach($users as $u):?>
    <option value="<?php echo $u->id; ?>" <?php if(isset($_GET["project_id"]) && $_GET["project_id"]==$u->id){ echo "selected"; } ?>><?php echo $u->name; ?></option>
  <?php endforeach; ?>
</select>
		</div>
    </div>
...
<option value="">Estado</option>
  <?php foreach($requests as $r):?>
    <option value="<?php echo $r->id; ?>" <?php if(isset($_GET["priority_id"]) && $_GET["priority_id"]==$r->id){ echo "selected"; } ?>><?php echo $r->name; ?></option>
  <?php endforeach; ?>
</select>
		</div>
    </div>
...
//echo $sql;
		...
		if(count($users)>0){
			...
			foreach($users as $user){
				...
				?>
				<tr>
				<td><a href='./?view=openticket&id=<?php echo $user->id;?>'>#<?php echo $user->id; ?></a></td>
