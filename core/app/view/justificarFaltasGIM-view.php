<?php
$request = AsistenciasData::getAllFaltasGIM();
if(count($request)>0){
?>
	<div class="callout callout-info">
	<h2><i class='fa fa-edit'></i> Justificación de Faltas GImnasia</h2>
	</div>
...
<div class="box-body">
			...
			foreach($request as $request1){
				...
				if ($request1->status==0) {
					?>
					<a href='./?view=editAsistenciaGim&id=<?php echo $request1->rgi;?>&fecha=<?php echo $request1->fecha;?>'><?php echo $request1->rgi; ?></a>
				<?php
				} else {
					echo $request1->rgi;
				}
