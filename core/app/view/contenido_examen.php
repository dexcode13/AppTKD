...
<page backtop="2mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
           ...
           <td style="width:50%; text-align: center" class=''>Fecha de Nac: <?php //echo $date_alumno->format('d-m-y'); ?></td>
        ...
        <tr>
           <td style="width:50%;" class=''>Nombre: <u><strong><?php //echo $alumno->nombre." ".$alumno->apellido;?></strong></u></td>
		   <td style="width:50%;" class=''>Edad: <u><strong><?php //echo $diff->y;?> años</strong></u></td>
        </tr> 
        <tr>
           <td style="width:50%;" class=''>Fecha de Exámen Anterior: _________________<strong></strong></td>
		   <td style="width:50%;" class=''>Grado y Cinta Actual: <u><strong><?php //echo $alumno->grado;?>° KUP Cinta Naranja</strong></u></td>
        </tr> 
        <tr>
           <td style="width:50%;" class=''>Fecha Exámen: <u><strong><?php echo date('Y-m-d');?></strong></u></td>
		   <td style="width:50%;" class=''>Grado y Cinta a Pasar: <u><strong>8° KUP Cinta Amarilla Baja</strong></u></td>
        </tr>
        <tr>
    ...
    <table cellspacing="0" style="width: 100%; text-align: center; font-size: 10pt;">
        <tr>
		   ...
		   <td style="width:50%;" class=''><hr>FIRMA DEL EXÁMINADOR</td>
           <td style="width:10%;" class=''><div class="circulo"></div></td>
