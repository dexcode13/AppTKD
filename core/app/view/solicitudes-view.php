...
<div class="box-body">
      ...
      <th>Correo</th>
			...
			foreach($request as $request1){
				...
				<tr>
        <td>
          <a href='./?view=opensolicitud&id=<?php echo $request1->rgi;?>'><?php echo $request1->rgi; ?></a>
        </td>
        <td><?php echo $request1->nombre." ".$request1->apellidos; ?></td>
				<td><?php echo $request1->grado; ?></td>
				<td><?php echo $request1->cinta; ?></td>
				<td><?php echo $request1->edad; ?></td>
