            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <h2>Una Solicitud ha sido registrada</h2><br>
                  <br>
                  Estimado Gerente,
                  Le informamos que un usuario de su departamento ha registrado una 
                  Solicitud. Para realizar un seguimiento de dicha solicitud, haga clic 
