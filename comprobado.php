            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <h2>Una Solicitud ha sido comprobada</h2><br>
                  <br>
                  Estimado Gerente de Administracion,
                  Le informamos que un usuario ha comprobado una 
                  Solicitud. Para realizar un seguimiento de dicha comprobacion, haga clic 
                  en el boton "AppViatic's" a continuacion para iniciar su sesion en el sistema.<br>
                  <br>
                      ...
                      <td style="width:100px;background:#D84A38;">
                        <div>
                          ...
                          <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:33px;v-text-anchor:middle;width:100px;" stroke="f" fillcolor="#D84A38">
                            ...
                            <center>
                          <![endif]-->
                              <a href="http://www.consultoresdiaf.com/AppViatics.4.0"
